...
class Seq2seq(nn.Module):
    ...
    def __init__(self, encoder1, decoder1, decoder2, decoder3, decode_function=F.log_softmax):
    ...
    def flatten_parameters(self):
        ...
        self.decoder3.rnn.flatten_parameters()

    def forward(self, input_variable1,  input_lengths1=None,
                target_variable1=None, target_variable2=None, target_variable3=None, teacher_forcing_ratio=0):
        ...
        result2 = self.decoder2(inputs=target_variable2,
                                ...
                                function=self.decode_function,
                                teacher_forcing_ratio=teacher_forcing_ratio)
        result3 = self.decoder3(inputs=target_variable3,
                                encoder_hidden=encoder_hidden1,
                                encoder_outputs=encoder_outputs1,
                                function=self.decode_function,
                                teacher_forcing_ratio=teacher_forcing_ratio)
