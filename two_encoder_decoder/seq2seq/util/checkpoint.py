...
class Checkpoint(object):
    ...
    def __init__(self, model, optimizer, epoch, step, input_vocab1, input_vocab2, output_vocab1, output_vocab2, path=None):
        self.model = model
    ...
    def load(cls, path):
        ...
        return Checkpoint(model=model, input_vocab1=input_vocab1, input_vocab2=input_vocab2,
