...
class Predictor(object):
    ...
    def __init__(self, model, bl_vocab, jz_vocab, label1_vocab, label2_vocab):
        """
    ...
    def get_decoder_features(self, src_seq_bl, src_seq_jz):
        ...
        with torch.no_grad():
            ...
            other1, other2 = self.model(src_id_seq_bl, src_id_seq_jz, [len(src_seq_bl)], [len(src_seq_jz)])
            softmax_list1, _, other1 = other1
            softmax_list2, _, other2 = other2
        return other1, other2

    def predict(self, src_seq_bl, src_seq_jz):
        ...
        """
        other1, other2 = self.get_decoder_features(src_seq_bl, src_seq_jz)
    ...
    def predict_n(self, src_seq_bl,src_seq_jz, n=1):
        ...
        Returns:
            tgt_seq (list): list of tokens in target language as predicted
                            by the pre-trained model
        """
        other = self.get_decoder_features(src_seq_bl,src_seq_jz)
