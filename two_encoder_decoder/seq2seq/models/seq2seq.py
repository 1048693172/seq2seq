...
class Seq2seq(nn.Module):
    ...
    def __init__(self, encoder1, encoder2, decoder1, decoder2, decode_function=F.log_softmax):
    ...
    def forward(self, input_variable1, input_variable2,  input_lengths1=None, input_lengths2=None,
