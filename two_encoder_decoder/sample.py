...
predictor = Predictor(seq2seq, bl_vocab, jz_vocab, label1_vocab, label2_vocab)
while True:
...
# output_vocab1 = torch.load("./test1.output_vocab")
# output_vocab2 = torch.load("./test2.output_vocab")
#
#
# #
# import sys
