...
class Predictor(object):
    ...
    def __init__(self, model, bl_vocab, label1_vocab, label2_vocab):
        """
    ...
    def get_decoder_features(self, src_seq_bl):
        ...
        with torch.no_grad():
            ...
            other1, other2 = self.model(src_id_seq_bl, [len(src_seq_bl)])
    ...
    def predict(self, src_seq_bl):
        ...
        """
        other1, other2 = self.get_decoder_features(src_seq_bl)
